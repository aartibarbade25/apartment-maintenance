        ...
        <div class="container-fluid header position-relative p-0">
            <nav class="navbar navbar-expand-lg fixed-top navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.php" class="navbar-brand p-0">
                    <h1 class="display-6 text-primary m-0"><i class="fas fa-envelope me-3"></i>SocietySynk</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                       ...
                       <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">WHY KHATA</a>
                            <div class="dropdown-menu m-0">
                                <a href="feature.html" class="dropdown-item">About</a>
                                <a href="pricing.html" class="dropdown-item">How It Work's</a>
                           </div>
                        </div>
                    ...
                    <a href="registration.php" class="btn btn-primary rounded-pill text-white py-2 px-4">Sign Up</a>
                </div>
            </nav>
